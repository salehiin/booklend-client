...
const BannerText = () => {
    return (
        <div>
            <div className="text-orange-600 text-left space-y-7 w-1/2 pl-20">
                ...
                <button className="btn text-[#01161e] bg-orange-600 hover:text-orange-600">Borrow A Book</button>
            </div>
        </div>
    );
};
